...
import pl.justrpg.api.util.TimeUtil;
...
public class TimerManager implements Listener
{
    ...
    public static void addTask(@NotNull Player player, TimerCallback<Player> call, int time) {
        ...
        t.runTaskLater(RPG.getPlugin(), (long) TimeUtil.SECOND.getTick(time));
    }
    
    private static void cancel(@NotNull TimerTask task, Player player) {
        task.cancel(player);
